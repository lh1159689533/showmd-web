...
<template>
  <div class='empty flex flex-col justify-center items-center pb-6'>
    <svg
      id='Layer_1' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300' width='406'
    ...
    >
      ...
      <path
        d='M222.12,97.6s-21.19-1-25.36,20.06S199.7,168,199.7,168l-31.95,8.59,1.61,3.81h45.58l14-32.8Z'
        fill='#D1D5DB'
      >
      </path>
      <path
        d='M222.12,97.6s-21.19-1-25.36,20.06S199.7,168,199.7,168l-31.95,8.59,1.61,3.81h45.58l14-32.8Z' fill='#fff'
        opacity='0.46'
      ></path>
      <path
      ...
      <path
        d='M222.12,97.6s47.53-9.11,63.77,0-17.83,93.86-17.83,93.86L218,189.88S174.2,106.31,222.12,97.6Z'
        fill='#D1D5DB'
      >
      </path>
      ...
      <path
        d='M264.8,101.92s-17.05,12.43-9.3,35.31c11.55,34.09-46.42,32.39-46.42,32.39L213.8,181l66.53-5.71,5.79-23Z'
        opacity='0.08'
      ></path>
      <polygon
        points='161.28 135.11 151.94 180.36 198.15 180.36 198.15 174.35 175.05 172.87 173.08 135.11 161.28 135.11'
        fill='#c9c9c9'
      ></polygon>
      <path
