...
<template>
  <div class='comment-empty flex flex-col justify-center items-center py-6'>
    ...
    >
      ...
      <rect
        x='80.59' y='169.47' width='26.22' height='3.54' transform='translate(-36.8 26.07) rotate(-13.27)'
        fill='#24285b'
      ></rect>
      <path
        d='M174.38,163.45s-23.12,8.6-26.26,24-20.68,39.81-45.45-7.84l-8.14,3.14s22.56,76.48,62.37,39.18S174.38,163.45,174.38,163.45Z'
        fill='#f4a28c'
      ></path>
      <path d='M102.67,179.57s-2.83-8.84-7.72-11.43a.89.89,0,0,0-1.27,1l.85,4.31s-6.38,4.18,0,9.3Z' fill='#f4a28c'>
      </path>
      ...
      <path d='M215.2,160.06s-25-9.71-48,7.95S174,248,174,248l43.15,1.44S273.75,197.65,215.2,160.06Z' fill='#D1D5DB'>
      </path>
      <path
      ...
      ></path>
      <path
        d='M205,163.45s-19.66,17.43-11,37.85c13.09,30.84,1.47,33.54-25.21,34.32l7.16,17.16,60.77-19.33-3.94-25Z'
        opacity='0.08'
      ></path>
      <path
      ...
      ></path>
      <rect
        x='177.17' y='201.32' width='26.88' height='37.38' transform='translate(-62.66 76.51) rotate(-19.56)'
        fill='#ffd200'
      ></rect>
      <rect
        x='179.92' y='200.9' width='10.13' height='5.63' transform='translate(-57.53 73.68) rotate(-19.56)'
        fill='#24285b'
      ></rect>
      <path d='M211.53,259.45s-15.76,2.13-12,5.78,13.12.92,13.12.92Z' fill='#D1D5DB'></path>
      <path d='M184.58,264.12l3.24-4.88s10,6.79,9,9.82C194.94,275.12,184.58,264.12,184.58,264.12Z' fill='#D1D5DB'>
      </path>
      <path
      ...
      <path
        d='M215.36,202.27s-24.18-32.8-6.85-41.53,36.26,17,39.19,26.38C247.7,187.12,237.79,201.1,215.36,202.27Z'
        fill='#D1D5DB'
      ></path>
      <path
        d='M215.36,202.27s-24.18-32.8-6.85-41.53,36.26,17,39.19,26.38C247.7,187.12,237.79,201.1,215.36,202.27Z'
